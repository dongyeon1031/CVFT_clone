...
def save_tsne_plot(sat_feat, grd_feat, out_path="./tsne_embeddings.png",
    ...
    plt.xlim(-100, 100)  # x축: 0.3 ~ 0.9
    plt.ylim(-100, 100)  # y축: 0 ~ 600
...
if __name__ == '__main__':
    ...
    with tf.Session(config=config) as sess:
        ...
        load_model_path = "../Model/CVUSA/CVFT/adamw?/48/model.ckpt"
        ...
        plt.xlim(0.3, 0.9)  # x축: 0.3 ~ 0.9
        plt.ylim(0, 700)  # y축: 0 ~ 600
